            ...
            <div className="prose prose-invert max-w-none">
              ...
              <div className="space-y-8">
                <section>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-theme-bg-secondary-light dark:bg-theme-bg-secondary-dark p-4 rounded-lg">
                      ...
                      <ul className="list-disc list-inside text-theme-text-secondary-light dark:text-theme-text-secondary-dark space-y-1">
                ...
                <section>
                  ...
                  <div className="space-y-4">
                    <div className="bg-theme-bg-secondary-light dark:bg-theme-bg-secondary-dark p-4 rounded-lg mb-4">
                      <h3 className="text-lg font-semibold text-theme-secondary-light dark:text-theme-secondary-dark mb-2">
                        Session Cookies
                      </h3>
                      <p className="text-theme-text-secondary-light dark:text-theme-text-secondary-dark">
                ...
                <section>
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="list-disc list-inside text-theme-text-secondary-light dark:text-theme-text-secondary-dark ml-4 space-y-2">
                ...
                <section>
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-theme-text-secondary-light dark:text-theme-text-secondary-dark text-sm italic">
                ...
                <section>
                  ...
                  <div className="bg-theme-bg-secondary-light dark:bg-theme-bg-secondary-dark p-4 rounded-lg">
                    ...
                    <ul className="text-theme-text-secondary-light dark:text-theme-text-secondary-dark space-y-2">
                      <li>
                        <strong className="text-theme-secondary-light dark:text-theme-secondary-dark">
                          Email:
                        </strong>{" "}
                ...
                <div className="bg-theme-bg-secondary-light dark:bg-theme-bg-secondary-dark p-6 rounded-lg mt-8">
                  <h2 className="text-xl font-bold text-theme-secondary-light dark:text-theme-secondary-dark mb-4">
                    Your Consent
                  </h2>
                  <p className="text-theme-text-secondary-light dark:text-theme-text-secondary-dark">
